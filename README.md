SMC-RNA Challenge Entry: jeltje-9605581
========================================================
...
```bash
# Clone this repo
git clone https://github.com/smc-rna-challenge/jeltje-9605581
cd jeltje-9605581
...
- [quay.io/smc-rna-challenge/jeltje-9605581-ericscript:1.0.0](https://quay.io/smc-rna-challenge/jeltje-9605581-ericscript:1.0.0)
...
[data]: https://www.synapse.org/#!Synapse:syn9878893
